...
game.catchPokemon = function(pokemonObj) {
  ...
  if (game.party <= 6) {
    game.party.push(pokemonObj);
  //else more than 6 will push pokemon to billsPc
  } else {
...
game.catchPokemon(pokedex[79])
game.catchPokemon(pokedex[130])
game.catchPokemon(pokedex[111])
game.catchPokemon(pokedex[114])
